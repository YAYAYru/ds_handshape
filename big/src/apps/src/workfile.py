...
class WorkFile:
    ...
    #TODO
    def save_np2videofile(self, np_video, file_path_to, fps):
        #print("np_video", np_video.shape)
        #print("np_video", np_video[0])
        skvideo.io.vwrite(file_path_to, np_video, outputdict={'-r': str(fps)})
        # vid = skvideo.io.vread(file_path_to)
        #print("vid", vid.shape)
        #print("vid", vid[0])